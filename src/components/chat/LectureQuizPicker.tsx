...
const LECTURES = [
  { number: 2, title: "Блокчейн: экономический смысл, применение и цифровые активы" },
  { number: 3, title: "Блокчейн: аккаунты, смарт-контракты, платформы и цифровые активы" },
  { number: 4, title: "Технологии, рынки и цифровые активы: экономика технологических укладов" },
  { number: 5, title: "Искусственный интеллект: технологии, агенты и трансформация бизнес-процессов" },
  { number: 6, title: "Стратегии переконфигурации рынков: IBM, OpenAI, Red Bull и цифровой финансовый суверенитет" },
];
